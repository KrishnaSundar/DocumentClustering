...
{  
    ...
    public static void stemmingDriver( File process ) throws IOException
    {
        char[] w = new char[501];
        ...
        try
        {
            ...
            PrintWriter Out = new PrintWriter(new BufferedWriter(new FileWriter("results/output"+(new Integer(descriptor).toString())+".txt")));		
            try
            { 
                while(true)
                {  int ch = in.read();
